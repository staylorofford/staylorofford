    ...
    for GPS in GPS_in:
        ...
        with open(GPS) as ssv:
            ...
            for line in ssv:
                ...
                for i in range(int(len(line)/25)):
                    if i==0:
                ...
                GPS_time[g].append(float(timeout))
...
#        vmax = v_data['vmax']*86400.0
        ...
        for day in range(len(vdatenum)):
            ...
            GPS_vel_time_out[g].append(float(str(jdate)+'.'+str(stime)[2:]))
            GPS_vel_out[g].append(float(v[day]))
...
#    v2_event_directory='/Volumes/arc_02/taylorsa/marginal_events'
    ...
    rainfall_times='/media/sam/61D05F6577F6DB39/SCIENCE/rainfall_data/rainfall_hours'
    rainfall_data='/media/sam/61D05F6577F6DB39/SCIENCE/rainfall_data/rainfall_hours_data' 
...
#    lake_times, lake_roc, lake_levels = lake_level(lake_level_data, year, start_date, end_date)
    ...
    GPS1_path='/media/sam/61D05F6577F6DB39/SCIENCE/TG_GNSS_PROCESSED/VEL4SAM/tas_position_arc5_1.txt'
    GPS2_path='/media/sam/61D05F6577F6DB39/SCIENCE/TG_GNSS_PROCESSED/VEL4SAM/tas_position_arc4_1.txt'
...
#    GPS2_vpath='/Volumes/arc_01/taylorsa/velocity_data/run2/c3_data_6hr_30samp'
    GPS1_vpath='/media/sam/61D05F6577F6DB39/SCIENCE/TG_GNSS_PROCESSED/c1_data_3hr_30samp'
    GPS2_vpath='/media/sam/61D05F6577F6DB39/SCIENCE/TG_GNSS_PROCESSED/c3_data_3hr_30samp'
    
    GPS1_path = '/home/sam/VEL4SAM/tas_position_arc5_1.txt'
    GPS2_path = '/home/sam/VEL4SAM/tas_position_arc4_1.txt'
    GPS1_vpath = '/home/sam/VEL4SAM/v1'
    GPS2_vpath = '/home/sam/VEL4SAM/v2'
...
#    plt.title('Crevassing',fontsize=16,fontweight='bold',y=1.03)
    ...
    ax2.plot(GPS_vel_time[1],GPS_vel[1], lw=1/2)#, color = colors[2], linestyle='--')    
    ax2.plot(GPS_vel_time[0],GPS_vel[0], lw=1/2)#, color = colors[1])
...
#    
    ...
    ax3.plot(GPS_time[1],z2pos, lw=1/2)#, color=colors[2], linestyle='--')    
    ax3.plot(GPS_time[0],z1pos, lw=1/2)#, color=colors[1])
...
#    ax1.set_xticklabels([]) 
    ...
    ax4=plt.gca()
#    
    ax4.plot(GPS_vel_time[0],strains, lw=1)#, color=colors[3])
